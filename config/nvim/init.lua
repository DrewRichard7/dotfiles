...
require("lazy").setup({
	...
	-- Snacks (notifications, zen, etc.)
	{
		...
		opts = {
			...
			picker = { enabled = true },
			styles = { notification = { wo = { wrap = true }, relative = "editor" } },
		},
		keys = {
			{
				"<leader>z",
...
-- REMOVED wk.add calls from here, they are now in the which-key plugin config
